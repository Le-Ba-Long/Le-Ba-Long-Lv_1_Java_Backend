...
public class StudentWS {
	...
	private static final String url = "http://localhost:8080/classwebservice?wsdl";
	...
	public String addStudentReal(@WebParam(name = "username") String username,
			...
			@WebParam(name = "age") Integer age, @WebParam(name = "code") String code,
			@WebParam(name = "className") String className, @WebParam(name = "address") String address,
